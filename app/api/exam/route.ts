      ...
      messages: [
        {
          ...
          content: [
            ...
            '지금은 신체진찰 단계이다. 시험관(의사)의 **이번 발화(transcript) 한 문장에서 실제로 묻거나 요청한 것에만** 답한다. 묻지 않은 부위·검사·소견은 **한 단어도** 덧붙이지 않는다.',
            '**예/아니오·될까요/괜찮으세요**처럼 단답으로 끝나는 질문에는 **예/아니요/네/괜찮아요** 등 **최소한**으로만 답하고, 같은 내용을 길게 설명하지 않는다.',
